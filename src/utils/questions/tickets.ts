...
export const tickets: { title: string; items: QuestionsList }[] = [
  {
    title: "Билет #1",
    items: [
      {
      ...
      {
        title:
          "Действия по полному прекращению стрельбы в тире (на стрельбище):",
        items: [
          {
            title:
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title:
              "Стрелять по пернатой дичи, сидящей на нижних ветках деревьев",
            isRight: false,
          },
          {
            title:
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title:
              "На приведение в негодность оружия (разрыв ствола и его частей)",
            isRight: true,
          },
        ],
      },
    ...
    items: [
      {
        ...
        items: [
          ...
          {
            title:
              "Обязаны, кроме случаев, когда оружие находится в его багаже.",
            isRight: false,
          },
          {
            title: "Не обязаны.",
